...
public class SynchronousMessageTriggerSunnyDayTests {
	
	private static final Log logger = LogFactory.getLog(SynchronousMessageTriggerSunnyDayTests.class);
	...
	public void checkPostConditions() {
        this.logger.debug("------excute syschronous transaction and test time------"+(System.currentTimeMillis()-this.begintime));
