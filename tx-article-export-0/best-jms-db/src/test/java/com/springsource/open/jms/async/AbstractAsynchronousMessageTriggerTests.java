...
public abstract class AbstractAsynchronousMessageTriggerTests implements
	...
	private static final Log logger = LogFactory.getLog(AbstractAsynchronousMessageTriggerTests.class);
	...
	public void waitForMessages() throws Exception {
        logger.debug("------excute test need time------"+(System.currentTimeMillis()-begintime));
		int count = 0;
